          ...
          <div className="bg-white border border-[#e5e5e5] rounded-3xl shadow-sm overflow-hidden">
            ...
            <div className="px-10 py-8 text-center">
              <p className="text-[#4a4a4a] leading-relaxed mb-8">
                Weather anxiety is real. This guide covers the best apps for tracking your wedding day forecast — so you're always prepared, no matter what the sky has planned.
              </p>
